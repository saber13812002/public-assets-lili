...
(function ($) {
    ...
    DOC.ready(function () {
        ...
        DOC.on('click','.gallery-custom-action .base-action button.replace',function(){
            ...
            new MediaLibrary({
                ...
                saveUrl: '/api/gallery/photo-save',
    ...
    DOC.on('click', '#upload_new_other_video, #other_video_list .replace-new-video', function (e) {
        ...
        new MediaLibrary({
            ...
            saveUrl: '/api/gallery/video-save',
            fetchUrl: '/api/gallery/video/',
            uploadUrl: '/api/gallery/video-upload',
            translate: {
    ...
    DOC.on('click', '#upload_new_voice', function (e) {
        ...
        new MediaLibrary({
            ...
            multiple: true,
            openOnLibrary: false,
            saveUrl: '/api/gallery/audio-save',
            fetchUrl: '/api/gallery/audio/',
            uploadUrl: '/api/gallery/audio-upload',
            translate: {
