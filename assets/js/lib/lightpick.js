...
(function (root, factory) {
    ...
    var document = window.document,
        ...
        renderTopButtons = function (opts) {
            return ''
                + ''
                + '<button type="button" class="lightpick__previous-action"><i class="icon-arrow-left"></i></button>'
                + '<button type="button" class="lightpick__next-action"><i class="icon-arrow-right"></i></button>'
        ...
        renderMonthsList = function (date, opts) {
            ...
            // edited
            return `<div class="month-name">${date.toDate().toLocaleString(opts.lang, { month: 'long' })}</div>`;
        ...
        renderYearsList = function (date, opts) {
            ...
            // edited
            return `<div class="year-name">${date.toDate().getFullYear()}</div>`;
            // return select.outerHTML;
        },
